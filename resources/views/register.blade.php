...
<head>
    ...
    <title>Đăng ký - Pizza Shop</title>
    <style>
...
<div class="page">
    <div class="card">
        <div class="card-header">
            <h1>Đăng ký Pizza Shop</h1>
            <p>Tạo tài khoản để đặt món nhanh chóng</p>
        </div>
        <div class="card-body">
            @if ($errors->any())
                <div class="alert">
            ...
            <a class="secondary" href="{{ route('login') }}">Đã có tài khoản? Đăng nhập</a>
        </div>
        <div class="footer">Kết nối XAMPP MySQL để lưu thông tin khách hàng.</div>
    </div>
</div>
</body>
</html>
